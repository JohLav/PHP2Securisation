    ...
    <div class="container">
        ...
        <p>
            ...
            <?php echo 'Merci ' .$_POST['firstname']. ' ' .$_POST['lastname'].
                ...
                '. L\'un de nos conseillers prendra contact avec vous dans les plus brefs délais pour traiter votre demande à l\'adresse '
                .$_POST['email']. ' ou par téléphone au ' .$_POST['tel']. '<br>' . '<br>' . 'Pour rappel, voici votre message :' . '<br>' . $_POST['message']; ?>
        </p>
    </div>
</body>
